...
class MySQL extends DatabaseBase
{
	...
	public function connect()
	{
		...
		$connectionString		= "mysql:dbname=".$this->getSchema().";host=".$this->getHost();
	...
	public function querySEL($sql)
	{
		...
		for ($count = 0 ; $count < count($this->_preparedArray) ; $count++)
		{
			$tempPreparedHash[$this->_preparedMark.($count + 1)] = $this->_preparedArray[$count];
		}
